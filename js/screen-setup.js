          ...
          <div class="setup-section-body">
            ...
            <div class="field-row">
              <div class="field-group">
                ...
                <input class="field-input" type="number" id="edit-luft" value="${_editSession.temperatur?.luft ?? ''}">
              </div>
              <div class="field-group">
                <label class="field-label">Asphalttemperatur (°C)</label>
                <input class="field-input" type="number" id="edit-asphalt" value="${_editSession.temperatur?.asphalt ?? ''}">
              </div>
            </div>
          </div>
        </div>` : ''}
          ...
          <div class="setup-section-body">
            ...
            <div class="field-row">
              <div class="field-group">
                ...
                <input class="field-input" type="number" id="gabel-oeltyp" value="${pre.gabel?.oeltyp ?? ''}" placeholder="z.B. 5">
              </div>
              <div class="field-group">
                <label class="field-label">Öllevel (mm)</label>
                <input class="field-input" type="number" id="gabel-oelstand" value="${pre.gabel?.oelstand_mm ?? ''}" placeholder="z.B. 110">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="setup-section-body">
            <div class="field-row">
              <div class="field-group">
                ...
                <input class="field-input" type="number" id="sek-ritzel" value="${pre.sekundaer?.ritzel ?? ''}" placeholder="z.B. 16">
              </div>
              <div class="field-group">
                <label class="field-label">Kettenrad (Zähne)</label>
                <input class="field-input" type="number" id="sek-kettenrad" value="${pre.sekundaer?.kettenrad ?? ''}" placeholder="z.B. 42">
              </div>
            </div>
            <div class="field-row">
              <div class="field-group">
                <label class="field-label">Kettenlänge (Glieder)</label>
                <input class="field-input" type="number" id="sek-kettenlaenge" value="${pre.sekundaer?.kettenlaenge ?? ''}" placeholder="z.B. 112">
              </div>
              <div class="field-group">
          ...
          <div class="setup-section-body">
            <div class="field-row">
              <div class="field-group">
                ...
                <input class="field-input" type="number" id="elek-tc-stufe" value="${pre.elektronik?.tc_stufe ?? ''}" placeholder="z.B. 3">
              </div>
              <div class="field-group">
