      ...
      <div class="scroll-content" style="padding-top:16px">
        ...
        <div class="field-row">
          <div class="field-group">
            ...
            <input class="field-input" type="number" step="0.01" id="wiz-luft" value="${state.temperatur.luft}" placeholder="z.B. 22">
          </div>
          <div class="field-group">
            <label class="field-label">Asphalttemperatur (°C)</label>
            <input class="field-input" type="number" step="0.01" id="wiz-asphalt" value="${state.temperatur.asphalt}" placeholder="z.B. 38">
          </div>
        </div>
